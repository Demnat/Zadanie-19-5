...
App = React.createClass({
  ...
  // function (searchingText, callback) {  // Na wejście metody getGif przyjmujemy dwa parametry: wpisywany tekst (searchingText) i funkcję, która ma się wykonać po pobraniu gifa (callback)
